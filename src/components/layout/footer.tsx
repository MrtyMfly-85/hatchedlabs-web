      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-6 py-14 lg:grid-cols-[1.2fr_.8fr_.8fr] lg:px-8">
        <div className="space-y-4">
          ...
          <p className="max-w-md text-sm leading-7 text-ink-300">
            Personal AI assistants — Built for you. Working for you.
            <br />
            Only for you.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="mt-5 flex flex-col gap-3 text-sm text-ink-300">
            ...
            <div className="mt-2 flex items-center gap-5">
              <a href="https://www.facebook.com/HatchedLabs/" target="_blank" rel="noopener noreferrer" className="text-ink-300 transition hover:text-white" aria-label="Facebook">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://www.instagram.com/hatchedlabs/" target="_blank" rel="noopener noreferrer" className="ml-0.5 text-ink-300 transition hover:text-white" aria-label="Instagram">
              ...
              <a href="https://x.com/HatchedLabsAI" target="_blank" rel="noopener noreferrer" className="text-ink-300 transition hover:text-white" aria-label="X">
