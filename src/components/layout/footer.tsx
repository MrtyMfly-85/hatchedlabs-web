        ...
        <div>
          ...
          <div className="mt-5 flex flex-col gap-3 text-sm text-ink-300">
            ...
            <div className="mt-2 flex items-center gap-4">
              ...
              <a href="https://www.instagram.com/hatchedlabs/" target="_blank" rel="noopener noreferrer" className="text-ink-300 transition hover:text-white" aria-label="Instagram">
