...
export const tiers = {
  pro: {
    ...
    features: [
      ...
      "Content & Social Media Drafting",
      "Communication Drafts & Follow-Ups",
      "Admin & Organization",
      "Multi-Tasking — deploys its own assistant-bot",
    ],
  },
  elite: {
    id: "elite" as TierId,
    ...
    description:
      "For professionals who need a fully integrated AI assistant — connected to their email, calendar, and cloud, with advanced multi-tasking.",
    ...
    features: [
      ...
      "OneDrive Access",
      "Advanced Multi-Tasking — deploys a team of 4 additional bots",
    ],
  },
};
